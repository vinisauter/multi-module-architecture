...
public class CustomFlutterLoader extends FlutterLoader {
    ...
    /**
     * Creates a {@code CustomFlutterLoader} that uses a default constructed {@link FlutterJNI} and {@link
     * ExecutorService}.
     */
    public CustomFlutterLoader() {
        this(FlutterInjector.instance().getFlutterJNIFactory().provideFlutterJNI());
    }

    /**
     * Creates a {@code CustomFlutterLoader} that uses a default constructed {@link ExecutorService}.
     *
     ...
     */
    public CustomFlutterLoader(@NonNull FlutterJNI flutterJNI) {
        this(flutterJNI, FlutterInjector.instance().executorService());
    }

    /**
     * Creates a {@code CustomFlutterLoader} with the specified {@link FlutterJNI}.
     *
     * @param flutterJNI The {@link FlutterJNI} instance to use for loading the libflutter.so C++
     *     library, setting up the font manager, and calling into C++ initialization.
     * @param executorService The {@link ExecutorService} to use when creating new threads.
     */
    public CustomFlutterLoader(@NonNull FlutterJNI flutterJNI, @NonNull ExecutorService executorService) {
...
//            final Context appContext = applicationContext;//.getApplicationContext();
            ...
            flutterApplicationInfo = CustomApplicationInfoLoader.load(context);
            ...
            Callable<InitResult> initTask =
                    new Callable<InitResult>() {
                        ...
                        public InitResult call() {
                            ...
                            try {
                                CustomResourceExtractor resourceExtractor = initResources(context);
                                ...
                                return new InitResult(
                                        ...
                                        PathUtils.getCacheDirectory(context),
...
//        }
    ...
    private CustomResourceExtractor initResources(@NonNull Context applicationContext) {
        CustomResourceExtractor resourceExtractor = null;
        if (BuildConfig.DEBUG || BuildConfig.JIT_RELEASE) {
            ...
            resourceExtractor =
                    new CustomResourceExtractor(dataDirPath, packageName, packageManager, assetManager);
