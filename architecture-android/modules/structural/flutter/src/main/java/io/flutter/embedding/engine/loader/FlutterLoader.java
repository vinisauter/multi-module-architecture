...
public class FlutterLoader {
    ...
    @Nullable private io.flutter.embedding.engine.loader.FlutterLoader.Settings settings;
    ...
    @Nullable Future<io.flutter.embedding.engine.loader.FlutterLoader.InitResult> initResultFuture;
    ...
    public void startInitialization(@NonNull Context applicationContext) {
        startInitialization(applicationContext, new io.flutter.embedding.engine.loader.FlutterLoader.Settings());
    }
     ...
     */
    public void startInitialization(@NonNull Context applicationContext, @NonNull io.flutter.embedding.engine.loader.FlutterLoader.Settings settings) {
        ...
        try {
            ...
            Callable<io.flutter.embedding.engine.loader.FlutterLoader.InitResult> initTask =
                    new Callable<io.flutter.embedding.engine.loader.FlutterLoader.InitResult>() {
                        @Override
                        public io.flutter.embedding.engine.loader.FlutterLoader.InitResult call() {
                            ...
                            try {
                                ...
                                return new io.flutter.embedding.engine.loader.FlutterLoader.InitResult(
    ...
    public void ensureInitializationComplete(
        ...
        try {
            io.flutter.embedding.engine.loader.FlutterLoader.InitResult result = initResultFuture.get();
    ...
    public void ensureInitializationCompleteAsync(
        ...
        executorService.execute(
                () -> {
                    io.flutter.embedding.engine.loader.FlutterLoader.InitResult result;
                    try {
