...
class _AnalyticsApiCodec extends StandardMessageCodec {
  const _AnalyticsApiCodec();
}
...
class AnalyticsApi {
  ...
  /// available for dependency injection.  If it is left null, the default
  /// BinaryMessenger will be used which routes to the host platform.
  AnalyticsApi({BinaryMessenger? binaryMessenger}) : _binaryMessenger = binaryMessenger;

  final BinaryMessenger? _binaryMessenger;

  static const MessageCodec<Object?> codec = _AnalyticsApiCodec();

  Future<void> sendScreenView(String arg_eventName) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AnalyticsApi.sendScreenView', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
  ...
  Future<void> sendInteraction(String arg_category, String arg_action, String arg_label) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.AnalyticsApi.sendInteraction', codec, binaryMessenger: _binaryMessenger);
    final Map<Object?, Object?>? replyMap =
        await channel.send(<Object>[arg_category, arg_action, arg_label]) as Map<Object?, Object?>?;
    if (replyMap == null) {
      throw PlatformException(
        code: 'channel-error',
        message: 'Unable to establish connection on channel.',
