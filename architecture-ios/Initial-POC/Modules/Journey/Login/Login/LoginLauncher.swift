...
public class LoginLauncher {
    static public func start(with dependencies: LoginDependencies) -> UIViewController {
        let businessModel = LoginBusinessModel(repository: LoginAPI(network: dependencies.structuralDependencies.networking), structuralAnalytics: dependencies.structuralDependencies.analytics)
