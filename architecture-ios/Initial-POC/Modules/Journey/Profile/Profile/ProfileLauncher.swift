...
public protocol ProfileStructuralDependencies {
    var networking: NetworkingProviderProtocol { get }
...
public class ProfileLauncher {
    static public func start(with dependencies: ProfileDependencies) -> UIViewController {
        let businessModel = ProfileBusinessModel(repository: ProfileAPI(network: dependencies.structuralDependencies.networking), structuralAnalytics: dependencies.structuralDependencies.analytics)
