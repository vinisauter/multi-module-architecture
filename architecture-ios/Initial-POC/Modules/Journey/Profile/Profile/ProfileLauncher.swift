...
public class ProfileLauncher {
    static public func start(from deeplink: URL?, baseFlowDelegate: BaseFlowDelegate?, baseFlowDataSource: BaseFlowDataSource? = nil, httpClient: HTTPClient, analytics: AnalyticsProtocol, customProfileAnalytics: ProfileAnalyticsProtocol?) -> UIViewController {
