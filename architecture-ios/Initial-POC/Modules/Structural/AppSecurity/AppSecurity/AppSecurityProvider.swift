...
public class AppSecurityProvider: AppSecurityProviderProtocol {
    ...
    public init() {
//        AppSecurityProvider.generateKeys()
    }
    ...
    public func getCertificate() -> String {
        ...
        let decryptedMessage = decrypt(fromBase64String: encryptedString, withKey: privateKey)
    ...
    private func vEncrypt(string: String, publicKey: SecKey) -> String? {
        ...
        if SecKeyEncrypt(publicKey, SecPadding.PKCS1,
            ...
            return Data(bytes: UnsafePointer<UInt8>(encrypt_bytes), count: output_size).base64EncodedString()
        }
        return nil
    }
    
    public func decrypt(fromBase64String base64String: String, withKey key: String) -> String? {
