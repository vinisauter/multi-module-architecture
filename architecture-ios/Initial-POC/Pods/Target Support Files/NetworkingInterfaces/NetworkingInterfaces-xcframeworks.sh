...
install_xcframework "${PODS_ROOT}/NetworkingInterfaces/NetworkingInterfaces.xcframework" "NetworkingInterfaces" "framework" "ios-arm64_x86_64-simulator" "ios-arm64"
